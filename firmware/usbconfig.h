 ...
 */
//#define USB_RX_USER_HOOK(data, len)     { usb_recv((data), (len)); }
 ...
 */
#define USB_CFG_VENDOR_NAME     'm', 'o', 'n', 'k', 'e', 'y', 'p', 'u', 'p', 'p', 'e', 't', \
        'l', 'a', 'b', 's', '.', 'c', 'o', 'm'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'U', 'S', 'B', 'C', 'o', 'n', 't', 'r', 'o', 'l', 'l', 'e', 'r'
